...
public class ShootingDeathRazer : MonoBehaviour
{
    ...
    void ShootDeathRazer()
    {
        ...
        //{
            ...
            //Debug.Log("발사 " + count);
            GameObject deathRazer = Instantiate(DeathRazerPrefab, new Vector3(bossTransform.position.x, bossTransform.position.y - 3.06f, 0), Quaternion.identity); //다이만지 기준 위치 설정
            //count--;
